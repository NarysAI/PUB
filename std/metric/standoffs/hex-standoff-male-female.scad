// Parametric metric hex standoff: male thread and female thread.
// Dimensions are millimetres. The external helix is cosmetic; major diameter,
// pitch, body envelope and female-thread core envelope are dimensional.
