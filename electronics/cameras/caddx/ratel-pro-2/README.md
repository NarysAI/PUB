...
The source declares twelve named visualization materials. Five adjacent lens
stages use alternating graphite shades, while the transition, blue-tinted
glass, lighter housing, green sensor PCB, light rear connector, dark rear
components, and gold contacts remain visually distinct. NarysAI renders these
layers separately and combines them into a color-preserving GLB preview; the
declarations do not add external dependencies to the SCAD model.
